...
from ModelTrain.handlers.save_to_json import save_prices_prediction
...
def load_models():
    ...
    """
    rf_model = joblib.load("models_cars/model_cars_prediction_prices/random_forest_model.pkl")
    xgb_model = joblib.load("models_cars/model_cars_prediction_prices/xgboost_model.pkl")
    dnn_model = keras.models.load_model("models_cars/model_cars_prediction_prices/dnn_model.h5", compile=False)
    
    scaler = joblib.load("models_cars/model_cars_prediction_prices/scaler.pkl")
    label_encoders = joblib.load("models_cars/model_cars_prediction_prices/label_encoders.pkl")
